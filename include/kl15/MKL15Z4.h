...
**
**     Abstract:
**         This header file implements peripheral memory map for MKL15Z4
**         processor.
**
 ...
 * @version 1.2
 * @date 2012-10-04
 * @brief Peripheral memory map for MKL15Z4
 *
 * This header file implements peripheral memory map for MKL15Z4 processor.
 */
...
#if !defined(MCU_MKL15Z4)  /* Check if memory map has not been already included */
#define MCU_MKL15Z4

/* Check if another memory map has not been also included */
#if (defined(MCU_ACTIVE))
  #error MKL15Z4 memory map: There is already included another memory map. Only one memory map can be included.
